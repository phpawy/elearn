...
if (isset($_GET['do']) && $_GET['do'] == 'comment') {
    ...
    $db->query("INSERT INTO `comments` (`student_id`, `course_id`, `text`) VALUES ('$student_id', '$course_id', '$comment')");
}
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="well bs-component">
                        ...
                        <table cellpadding="10">
                            ...
                            while ($com = $comments->fetch_array()) {
                                ...
                                echo '<tr><td width="94" bgcolor="#D8D8D8">' . ($student['username'] ? $student['username'] : 'Professor') . '</td><td>' . $com['text'] . '</td></tr>';
                            }
                            ?>
                        ...
                        <table cellpadding="10">
                            ...
                            <?php
                            $qzs = $db->query("SELECT * FROM `exams` WHERE `course_id` = $id");
                            $i=1;
                            while ($qz = $qzs->fetch_array()) {
                                echo '<tr>
                                        <th colspan="2"><a href="student_quiz.php?quiz_id='.$qz['id'].'">Take Quiz '.$i.'</a></th>
                                    </tr>';
                                $i++;
                            }
                            ?>
